...
#define _DUTY_MAX 2600 // servo full counterclockwise position (180 degree)(doesn't go fully)
...
void loop() {
  ...
  if (dist_ema < _TARGET_LOW) {
    ...
    myservo.writeMicroseconds(map(dist_ema, _TARGET_LOW, _TARGET_HIGH, _DUTY_MIN, _DUTY_MAX));           // LED ON      
  }
